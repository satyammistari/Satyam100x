...
const initialColumns: Column[] = [
  ...
  },
  {
    ...
    tasks: [
      {
        id: 'ehealthwave',
        title: 'eHealthWave Platform',
        description: 'Secure, intelligent healthcare for everyone.',
        tag: { color: 'blue', label: 'Featured' },
        dueDate: 'Live',
        assignees: 2,
        progress: { completed: 1, total: 1 },
        image: 'C:/Users/SATYAM/OneDrive/Pictures/ehealthwave-chariot.png',
        liveLink: 'https://e-healthwave.netlify.app/'
      },
      {
        id: 't8',
...
const TaskBoard: React.FC<TaskBoardProps> = ({ className }) => {
  ...
  return (
    <div className={`flex gap-8 overflow-x-auto pb-6 px-2 ${className}`}>
      {columns.map(column => (
        <TaskColumn
          key={column.id}
          column={column}
